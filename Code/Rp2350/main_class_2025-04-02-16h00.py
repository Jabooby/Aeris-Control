...
class MotorController:
    ...
    async def motorMOVE(self):
        ...
        stepSizeZ, speedZ = 50, DEFAULT_SPEED
        ...
        while True:
            ...
            if self.JSONData.get("ZRight") and not self.JSONData.get("ZLeft"):
                stepZ, speedZ = stepSizeZ, DEFAULT_SPEED
            elif self.JSONData.get("ZLeft") and not self.JSONData.get("ZRight"):
                stepZ, speedZ = -stepSizeZ, DEFAULT_SPEED
            else:
                stepZ, speedZ = 0, 1
...
if __name__ == "__main__":
    ...
    controller.run()
    controller.motorZ.reset_motorZ()
